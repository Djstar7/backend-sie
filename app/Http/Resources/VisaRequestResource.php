...
class VisaRequestResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'profil' => [
                'first_name' => $this->profil->first_name ?? null,
                'last_name' => $this->profil->last_name ?? null,
                'phone' => $this->profil->phone ?? null,
                'date_of_birth' => $this->profil->date_of_birth->format('Y-m-d'),
                'place_of_birth' => $this->profil->place_of_birth->format('Y-m-d'),
            ],
